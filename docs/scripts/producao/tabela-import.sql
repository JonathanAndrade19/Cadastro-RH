...
--
-- Estrutura da tabela `servidor_import`
--

DROP TABLE IF EXISTS `servidor_import`;
CREATE TABLE IF NOT EXISTS `servidor_import` (
...
Error Code: 1292. Incorrect datetime value: '0000-00-00 00:00:00' for column 'data_alteracao' at row 1
